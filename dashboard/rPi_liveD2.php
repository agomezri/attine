...
<?php 
	...
	$result = mysqli_query($connection, "SELECT timeStamp, Temp2 FROM Temperature order by timeStamp desc limit 50");
        if (!$result) {
        ...
        while ($row = mysqli_fetch_array($result)) {
                ...
                $temp = $row['Temp2']*1; //temperature in Celsius
                
                $data[] = array($time, $temp);
