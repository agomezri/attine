...
<script type="text/javascript">
    var chart;
       function requestData() {
			$.ajax({
				url: 'http://localhost/~alejandrogomezrivera/attine/dashboard/face1D.php',
				dataType: "json",
				success: function(data1) {
					chart.series[0].setData(data1),
					$.ajax({
						url: 'http://localhost/~alejandrogomezrivera/attine/dashboard/face4D.php',
						dataType: "json",
      ...
      $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            title: {text: 'Average Face Pressures'},
